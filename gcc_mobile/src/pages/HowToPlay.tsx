      ...
      <IonContent>
            ...
            <IonCol>
              ...
              <IonText>
                ...
                <div className="Points">
                  ...
                  Github username to be able to submit code. You can participate
                  as an individual and compete with others in your region as
                  well as participants all over the globe.
                </div>
              </IonText>
              <br></br>
              <IonText>
                ...
                <div className="Points">
                  ...
                  C# or JavaScript. You can submit questios multiple times, so
                  feel free to experiment, and do your best to achieve the
              ...
              <IonText>
                ...
                <div className="Points">
                  ...
                  through achievement badges earned through specific challenges
                  and tasks achieved during the competition.
                </div>
              </IonText>
              <br></br>
              <IonText>
                ...
                <div className="Points">
                  ...
                  will receive various prizes! There are also prizes for the
                  person who collects the most special engagement badges. These
                  particular badges don't add to your score, but they're still
                  worth collecting!
                </div>
              </IonText>
            </IonCol>
        ...
        <IonText>
          <p style={{ paddingLeft: 20 }}>
            ...
            Solutions would be evaluated on cyclomatic complexity, and scored
            ...
            during the competition. They can also earn points towards their
            total score by earning achievement badges, which are rewarded for
            achieving a variety of accomplishments throught the competition. All
            possible badges and their conditions are visible on the participants
            profile page. At 10am GMT, September 7th 2020, the Leaderboards will
            lock and the Global Coding Champion will be announced.
          </p>
        ...
        <div className="GreyBar">
          ...
          <div>
            ...
            <div>
              Nine original questions for you to answer using any of four
          ...
          <div>
            ...
            <div>
              ...
              coders of all 6 regions, and the coder with the most engagement
              badges.
            </div>
          </div>
        </div>
