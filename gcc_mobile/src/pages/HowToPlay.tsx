...
import { arrowDown, arrowForward, expand } from 'ionicons/icons';

const Buttn: React.FC <{ val: String , visible :boolean, txt: String }> = (props) => {
  const [visib, setVisib] = useState(props.visible);

  return (
  <>
  <IonButton color="dark"  onClick = {()=> {setVisib((visib) => !visib); }} className="buttn">
    
  <IonIcon icon={arrowDown} hidden={!visib} />
  <IonIcon icon={arrowForward} hidden={visib} />
  {props.val} 
  </IonButton>
  <div className="extra-info" hidden={!visib}>{props.txt}</div>
    ...
    <IonPage>
      ...
      <IonContent>
            ...
            <IonCol>
              ...
              <IonText>
                <div className="BulletPoints">
                  1. Register with your Github
                </div>
                <br/>
                <div className="Points">
                Sign up for the Global Coding Challenge using your GitHub username in order to be able to submit code.
                </div>
                <Buttn val = "Where can I sign up?" visible= {false} txt = "You can sign up for the Global Coding Challenge by moving to the 'My Profile' section. After logging into your GitHub account and filling out a quick form with basic info, you are good to begin!"/>
              </IonText>
              <br/>
              <br/>
              <IonText>
              ...
              <IonText>
                ...
                <br/>
                <div className="Points">
                At the end of the competition, September 7th, the top performing coders will receive various prizes!
                </div>
                <Buttn val = "How many prizes are there?" visible= {false} txt = "There are 23 prizes in total. The top coder globally receives the grand prize, but the top 3 coders from each region will also receive prizes. Additionally, the competitor with the most engagement badges will earn a prize. All of the prizes are described in the Prizes section further down this page."/>
              </IonText>
            </IonCol>
          </IonRow>
        </IonGrid>
        ...
        <IonText>
          ...
          The Global Coding Challenge is an online coding competition between TAs across the globe.
           Over 1 week, between August 31st and September 7th, TAs will be able to attempt solutions 
           to nine coding problems. Solutions will be evaluated on cyclomatic complexity, and scored 
           proportionally against solutions provided by other students. Participants can improve their 
           code as many times as they like during the competition. They can also earn points toward their
            total score by earning achievement badges, which are rewarded for achieving a variety of 
            accomplishments throughout the competition. All possible badges and their conditions are
             visible on the participant's profile page. At 10am GMT, September 7th 2020, the Leaderboards
              will lock and the Global Coding Champion will be announced. 
          </p>

          <p style={{paddingLeft:20}}>

          The competition has been entirely designed, built and run by our fellow TAs.
          </p>
        </IonText>
        ...
        <div className="GreyBar">
          ...
          <div>
            ...
            <div>
            Competition is split across 7 regions: UK, USA & Canada,
             Europe, India, Southeast Asia, Switzerland, and the rest of the world.
            </div>
          </div>
          <div>
            ...
            <div>
            9 original questions for you to answer using any of 5 popular programming languages.
            </div>
          </div>
          <div>
            ...
            coders of all 7 regions, and the coder with the most engagement badges.
            </div>
          </div>
        </div>
      </IonContent>
